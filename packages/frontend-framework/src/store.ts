...
import { AuthModule, AuthState } from "@ff-test-modularization/frontend-framework-shared/authenticationProvider";
import { FFStoreModule } from "@ff-test-modularization/frontend-framework-shared/module";
