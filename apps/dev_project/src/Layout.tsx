...
import {UILayer} from "@test-ff-publish/frontend-framework/uiLayer";
import {TranslateFunctionType} from "@test-ff-publish/frontend-framework/translationFunction";
import {BasicContentWrapper} from "@test-ff-publish/frontend-framework/basicContentWrapper";
import {Group} from "@test-ff-publish/frontend-framework/group";
...
import {simpleNavbarTabFactory} from "@test-ff-publish/frontend-framework/simpleNavbarTabFactory";
import {privilegedNavbarTabFactory} from "@test-ff-publish/frontend-framework/privilegedNavbarTabFactory";
import {ExampleComponent2} from "./components/exampleComponent2";
import {HeaderPanelElement} from "@test-ff-publish/frontend-framework/headerPanelElement";
import {PrimeIcons} from "primereact/api";
import {WHITE} from "@test-ff-publish/frontend-framework/constants";
import {HeaderMenuElement} from "@test-ff-publish/frontend-framework/headerMenuElement";
